 ...
 * </p>
 * <ul>
 *   <li>{@link m1ice.pdc.mhw.impl.ArmorSetImpl#getId <em>Id</em>}</li>
 *   <li>{@link m1ice.pdc.mhw.impl.ArmorSetImpl#getName <em>Name</em>}</li>
 *   <li>{@link m1ice.pdc.mhw.impl.ArmorSetImpl#getRank <em>Rank</em>}</li>
 *   <li>{@link m1ice.pdc.mhw.impl.ArmorSetImpl#getPieces <em>Pieces</em>}</li>
 *   <li>{@link m1ice.pdc.mhw.impl.ArmorSetImpl#getArmor <em>Armor</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ArmorSetImpl extends MinimalEObjectImpl.Container implements ArmorSet {
	...
	protected EClass eStaticClass() {
		return MHWPackage.Literals.ARMOR_SET;
	}
	...
	public void setId(int newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MHWPackage.ARMOR_SET__ID, oldId, id));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MHWPackage.ARMOR_SET__NAME, oldName, name));
	}
	...
	public void setRank(String newRank) {
		...
		rank = newRank;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MHWPackage.ARMOR_SET__RANK, oldRank, rank));
	}
	...
	public void setPieces(int newPieces) {
		...
		pieces = newPieces;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MHWPackage.ARMOR_SET__PIECES, oldPieces, pieces));
	}
	...
	public EList<Armor> getArmor() {
		if (armor == null) {
			armor = new EObjectContainmentEList<Armor>(Armor.class, this, MHWPackage.ARMOR_SET__ARMOR);
		}
		return armor;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case MHWPackage.ARMOR_SET__ARMOR:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MHWPackage.ARMOR_SET__ID:
				return getId();
			case MHWPackage.ARMOR_SET__NAME:
				return getName();
			case MHWPackage.ARMOR_SET__RANK:
				return getRank();
			case MHWPackage.ARMOR_SET__PIECES:
				return getPieces();
			case MHWPackage.ARMOR_SET__ARMOR:
				return getArmor();
		}
