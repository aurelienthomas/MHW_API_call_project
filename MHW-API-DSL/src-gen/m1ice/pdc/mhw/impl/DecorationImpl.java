 ...
 * </p>
 * <ul>
 *   <li>{@link m1ice.pdc.mhw.impl.DecorationImpl#getId <em>Id</em>}</li>
 *   <li>{@link m1ice.pdc.mhw.impl.DecorationImpl#getName <em>Name</em>}</li>
 *   <li>{@link m1ice.pdc.mhw.impl.DecorationImpl#getRarity <em>Rarity</em>}</li>
 *   <li>{@link m1ice.pdc.mhw.impl.DecorationImpl#getSkill <em>Skill</em>}</li>
 *   <li>{@link m1ice.pdc.mhw.impl.DecorationImpl#getSlot <em>Slot</em>}</li>
 *   <li>{@link m1ice.pdc.mhw.impl.DecorationImpl#getRank <em>Rank</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DecorationImpl extends MinimalEObjectImpl.Container implements Decoration {
	...
	public Skill getSkill() {
		if (skill != null && skill.eIsProxy()) {
			...
			if (skill != oldSkill) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, MHWPackage.DECORATION__SKILL, oldSkill, skill));
			}
		}
		return skill;
	}
	...
	public NotificationChain basicSetSkill(Skill newSkill, NotificationChain msgs) {
		...
		skill = newSkill;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MHWPackage.DECORATION__SKILL, oldSkill, newSkill);
	...
	public void setSkill(Skill newSkill) {
		if (newSkill != skill) {
			...
			if (skill != null)
				msgs = ((InternalEObject)skill).eInverseRemove(this, MHWPackage.SKILL__DECORATION, Skill.class, msgs);
			if (newSkill != null)
				msgs = ((InternalEObject)newSkill).eInverseAdd(this, MHWPackage.SKILL__DECORATION, Skill.class, msgs);
	...
	public Slot getSlot() {
		if (slot != null && slot.eIsProxy()) {
			...
			if (slot != oldSlot) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, MHWPackage.DECORATION__SLOT, oldSlot, slot));
			}
		}
		return slot;
	}
	...
	public NotificationChain basicSetSlot(Slot newSlot, NotificationChain msgs) {
		...
		slot = newSlot;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MHWPackage.DECORATION__SLOT, oldSlot, newSlot);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setSlot(Slot newSlot) {
		if (newSlot != slot) {
			NotificationChain msgs = null;
			if (slot != null)
				msgs = ((InternalEObject)slot).eInverseRemove(this, MHWPackage.SLOT__DECORATION, Slot.class, msgs);
			if (newSlot != null)
				msgs = ((InternalEObject)newSlot).eInverseAdd(this, MHWPackage.SLOT__DECORATION, Slot.class, msgs);
			msgs = basicSetSlot(newSlot, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MHWPackage.DECORATION__SLOT, newSlot, newSlot));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case MHWPackage.DECORATION__SLOT:
				if (slot != null)
					msgs = ((InternalEObject)slot).eInverseRemove(this, MHWPackage.SLOT__DECORATION, Slot.class, msgs);
