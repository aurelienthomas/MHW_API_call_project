 ...
 * </p>
 * <ul>
 *   <li>{@link m1ice.pdc.mhw.impl.CharmImpl#getSkill <em>Skill</em>}</li>
 *   <li>{@link m1ice.pdc.mhw.impl.CharmImpl#getName <em>Name</em>}</li>
 *   <li>{@link m1ice.pdc.mhw.impl.CharmImpl#getId <em>Id</em>}</li>
 *   <li>{@link m1ice.pdc.mhw.impl.CharmImpl#getRarity <em>Rarity</em>}</li>
 *   <li>{@link m1ice.pdc.mhw.impl.CharmImpl#getLevel <em>Level</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CharmImpl extends MinimalEObjectImpl.Container implements Charm {
	...
	public EList<Skill> getSkill() {
		if (skill == null) {
			skill = new EObjectWithInverseResolvingEList<Skill>(Skill.class, this, MHWPackage.CHARM__SKILL, MHWPackage.SKILL__CHARM);
		}
		return skill;
	}
