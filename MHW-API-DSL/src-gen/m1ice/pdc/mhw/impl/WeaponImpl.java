 ...
 * </p>
 * <ul>
 *   <li>{@link m1ice.pdc.mhw.impl.WeaponImpl#getSlot <em>Slot</em>}</li>
 *   <li>{@link m1ice.pdc.mhw.impl.WeaponImpl#getSkill <em>Skill</em>}</li>
 *   <li>{@link m1ice.pdc.mhw.impl.WeaponImpl#getName <em>Name</em>}</li>
 *   <li>{@link m1ice.pdc.mhw.impl.WeaponImpl#getId <em>Id</em>}</li>
 *   <li>{@link m1ice.pdc.mhw.impl.WeaponImpl#getType <em>Type</em>}</li>
 *   <li>{@link m1ice.pdc.mhw.impl.WeaponImpl#getRarity <em>Rarity</em>}</li>
 *   <li>{@link m1ice.pdc.mhw.impl.WeaponImpl#getAttack <em>Attack</em>}</li>
 *   <li>{@link m1ice.pdc.mhw.impl.WeaponImpl#getElement <em>Element</em>}</li>
 * </ul>
 *
 * @generated
 */
public class WeaponImpl extends MinimalEObjectImpl.Container implements Weapon {
	...
	public EList<Slot> getSlot() {
		if (slot == null) {
			slot = new EObjectContainmentEList<Slot>(Slot.class, this, MHWPackage.WEAPON__SLOT);
		}
		return slot;
	}
		...
		if (skill != null && skill.eIsProxy()) {
			...
			if (skill != oldSkill) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, MHWPackage.WEAPON__SKILL, oldSkill, skill));
			}
		}
		return skill;
	}
	...
	public NotificationChain basicSetSkill(Skill newSkill, NotificationChain msgs) {
		...
		skill = newSkill;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MHWPackage.WEAPON__SKILL, oldSkill, newSkill);
	...
	public void setSkill(Skill newSkill) {
		if (newSkill != skill) {
			...
			if (skill != null)
				msgs = ((InternalEObject)skill).eInverseRemove(this, MHWPackage.SKILL__WEAPON, Skill.class, msgs);
			if (newSkill != null)
				msgs = ((InternalEObject)newSkill).eInverseAdd(this, MHWPackage.SKILL__WEAPON, Skill.class, msgs);
			msgs = basicSetSkill(newSkill, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MHWPackage.WEAPON__SKILL, newSkill, newSkill));
	}
	...
	public Element getElement() {
		if (element != null && element.eIsProxy()) {
			...
			if (element != oldElement) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, MHWPackage.WEAPON__ELEMENT, oldElement, element));
			}
		}
		return element;
	}
	...
	public NotificationChain basicSetElement(Element newElement, NotificationChain msgs) {
		...
		element = newElement;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MHWPackage.WEAPON__ELEMENT, oldElement, newElement);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setElement(Element newElement) {
		if (newElement != element) {
			NotificationChain msgs = null;
			if (element != null)
				msgs = ((InternalEObject)element).eInverseRemove(this, MHWPackage.ELEMENT__WEAPON, Element.class, msgs);
			if (newElement != null)
				msgs = ((InternalEObject)newElement).eInverseAdd(this, MHWPackage.ELEMENT__WEAPON, Element.class, msgs);
			msgs = basicSetElement(newElement, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MHWPackage.WEAPON__ELEMENT, newElement, newElement));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case MHWPackage.WEAPON__SKILL:
				if (skill != null)
					msgs = ((InternalEObject)skill).eInverseRemove(this, MHWPackage.SKILL__WEAPON, Skill.class, msgs);
				return basicSetSkill((Skill)otherEnd, msgs);
			case MHWPackage.WEAPON__ELEMENT:
				if (element != null)
					msgs = ((InternalEObject)element).eInverseRemove(this, MHWPackage.ELEMENT__WEAPON, Element.class, msgs);
