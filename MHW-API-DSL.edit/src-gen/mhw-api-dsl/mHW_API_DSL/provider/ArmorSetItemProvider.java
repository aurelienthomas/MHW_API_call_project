...
import mhw-api-dsl.mHW_API_DSL.ArmorSet;
...
/**
 * This is the item provider adapter for a {@link mhw-api-dsl.mHW_API_DSL.ArmorSet} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ArmorSetItemProvider 
	...
	protected void addNamePropertyDescriptor(Object object)
	{
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ArmorSet_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ArmorSet_name_feature", "_UI_ArmorSet_type"),
				 MHW_API_DSLPackage.Literals.ARMOR_SET__NAME,
				 true,
				 false,
				 false,
	...
	protected void addRankPropertyDescriptor(Object object)
	{
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ArmorSet_rank_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ArmorSet_rank_feature", "_UI_ArmorSet_type"),
				 MHW_API_DSLPackage.Literals.ARMOR_SET__RANK,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addPiecesPropertyDescriptor(Object object)
	{
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ArmorSet_pieces_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ArmorSet_pieces_feature", "_UI_ArmorSet_type"),
				 MHW_API_DSLPackage.Literals.ARMOR_SET__PIECES,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object)
	{
		...
		newChildDescriptors.add
			(createChildParameter
				(MHW_API_DSLPackage.Literals.ARMOR_SET__ARMOR,
