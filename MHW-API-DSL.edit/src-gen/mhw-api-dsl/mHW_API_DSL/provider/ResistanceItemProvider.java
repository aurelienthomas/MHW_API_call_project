...
import mhw-api-dsl.mHW_API_DSL.Resistance;
...
/**
 * This is the item provider adapter for a {@link mhw-api-dsl.mHW_API_DSL.Resistance} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ResistanceItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Resistance_fire_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Resistance_fire_feature", "_UI_Resistance_type"),
				 MHW_API_DSLPackage.Literals.RESISTANCE__FIRE,
				 true,
				 false,
				 false,
	...
	protected void addWaterPropertyDescriptor(Object object)
	{
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Resistance_water_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Resistance_water_feature", "_UI_Resistance_type"),
				 MHW_API_DSLPackage.Literals.RESISTANCE__WATER,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
	...
	protected void addIcePropertyDescriptor(Object object)
	{
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Resistance_ice_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Resistance_ice_feature", "_UI_Resistance_type"),
				 MHW_API_DSLPackage.Literals.RESISTANCE__ICE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
	...
	protected void addThunderPropertyDescriptor(Object object)
	{
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Resistance_thunder_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Resistance_thunder_feature", "_UI_Resistance_type"),
				 MHW_API_DSLPackage.Literals.RESISTANCE__THUNDER,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
	...
	protected void addDragonPropertyDescriptor(Object object)
	{
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Resistance_dragon_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Resistance_dragon_feature", "_UI_Resistance_type"),
				 MHW_API_DSLPackage.Literals.RESISTANCE__DRAGON,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
