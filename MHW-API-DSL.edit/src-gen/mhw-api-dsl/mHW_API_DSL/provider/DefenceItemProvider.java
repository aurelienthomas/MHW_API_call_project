...
import mhw-api-dsl.mHW_API_DSL.Defence;
...
/**
 * This is the item provider adapter for a {@link mhw-api-dsl.mHW_API_DSL.Defence} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
	...
	protected void addAugmentedPropertyDescriptor(Object object)
	{
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Defence_augmented_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Defence_augmented_feature", "_UI_Defence_type"),
				 MHW_API_DSLPackage.Literals.DEFENCE__AUGMENTED,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
