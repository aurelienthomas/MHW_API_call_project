...
import mhw-api-dsl.mHW_API_DSL.Skill;
...
/**
 * This is the item provider adapter for a {@link mhw-api-dsl.mHW_API_DSL.Skill} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MHW_API_DSLPackage.Literals.SKILL__LEVEL,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
	...
	protected void addDescriptionPropertyDescriptor(Object object)
	{
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Skill_description_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Skill_description_feature", "_UI_Skill_type"),
				 MHW_API_DSLPackage.Literals.SKILL__DESCRIPTION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addSkillNamePropertyDescriptor(Object object)
	{
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Skill_skillName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Skill_skillName_feature", "_UI_Skill_type"),
				 MHW_API_DSLPackage.Literals.SKILL__SKILL_NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addArmorPropertyDescriptor(Object object)
	{
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Skill_armor_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Skill_armor_feature", "_UI_Skill_type"),
				 MHW_API_DSLPackage.Literals.SKILL__ARMOR,
				 true,
				 false,
				 true,
				 null,
