...
/**
 * This is the item provider adapter for a {@link mhw_api_dsl.mHW_API_DSL.Slot} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SlotItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addRankPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Slot_rank_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Slot_rank_feature", "_UI_Slot_type"),
						MHW_API_DSLPackage.Literals.SLOT__RANK, true, false, false,
	...
	protected void addDecorationPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Slot_decoration_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Slot_decoration_feature", "_UI_Slot_type"),
						MHW_API_DSLPackage.Literals.SLOT__DECORATION, true, false, true, null, null, null));
	}
	...
	public String getText(Object object) {
		...
		return getString("_UI_Slot_type") + " " + slot.getRank();
	}
