...
/**
 * This is the item provider adapter for a {@link mhw_api_dsl.mHW_API_DSL.Armor} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ArmorItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addIdPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Armor_id_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Armor_id_feature", "_UI_Armor_type"),
						MHW_API_DSLPackage.Literals.ARMOR__ID, true, false, false,
	...
	protected void addSlugPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Armor_slug_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Armor_slug_feature", "_UI_Armor_type"),
						MHW_API_DSLPackage.Literals.ARMOR__SLUG, true, false, false,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Armor_name_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Armor_name_feature", "_UI_Armor_type"),
						MHW_API_DSLPackage.Literals.ARMOR__NAME, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Armor_type_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Armor_type_feature", "_UI_Armor_type"),
						MHW_API_DSLPackage.Literals.ARMOR__TYPE, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addRankPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Armor_rank_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Armor_rank_feature", "_UI_Armor_type"),
						MHW_API_DSLPackage.Literals.ARMOR__RANK, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addRarityPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Armor_rarity_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Armor_rarity_feature", "_UI_Armor_type"),
						MHW_API_DSLPackage.Literals.ARMOR__RARITY, true, false, false,
						ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE, null, null));
	}
	...
	protected void addImageMalePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Armor_imageMale_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Armor_imageMale_feature",
								"_UI_Armor_type"),
						MHW_API_DSLPackage.Literals.ARMOR__IMAGE_MALE, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addImageFemalePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Armor_imageFemale_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Armor_imageFemale_feature",
								"_UI_Armor_type"),
						MHW_API_DSLPackage.Literals.ARMOR__IMAGE_FEMALE, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addDefencePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Armor_defence_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Armor_defence_feature", "_UI_Armor_type"),
						MHW_API_DSLPackage.Literals.ARMOR__DEFENCE, true, false, true, null, null, null));
	}
	...
	protected void addResistancePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Armor_resistance_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Armor_resistance_feature",
								"_UI_Armor_type"),
						MHW_API_DSLPackage.Literals.ARMOR__RESISTANCE, true, false, true, null, null, null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MHW_API_DSLPackage.Literals.ARMOR__SKILL);
		}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_Armor_type")
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(MHW_API_DSLPackage.Literals.ARMOR__SLOT,
				MHW_API_DSLFactory.eINSTANCE.createSlot()));

		newChildDescriptors.add(createChildParameter(MHW_API_DSLPackage.Literals.ARMOR__SKILL,
				MHW_API_DSLFactory.eINSTANCE.createSkill()));
	}
