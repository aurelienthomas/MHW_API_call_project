...
/**
 * This is the item provider adapter for a {@link mhw_api_dsl.mHW_API_DSL.Item} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ItemItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addIdPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Item_id_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Item_id_feature", "_UI_Item_type"),
						MHW_API_DSLPackage.Literals.ITEM__ID, true, false, false,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Item_name_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Item_name_feature", "_UI_Item_type"),
						MHW_API_DSLPackage.Literals.ITEM__NAME, true, false, false,
	...
	protected void addDescriptionPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Item_description_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Item_description_feature",
								"_UI_Item_type"),
						MHW_API_DSLPackage.Literals.ITEM__DESCRIPTION, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addRarityPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						MHW_API_DSLPackage.Literals.ITEM__RARITY, true, false, false,
						ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE, null, null));
	}
