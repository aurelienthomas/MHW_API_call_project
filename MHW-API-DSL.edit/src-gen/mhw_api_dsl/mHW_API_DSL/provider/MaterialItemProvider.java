...
/**
 * This is the item provider adapter for a {@link mhw_api_dsl.mHW_API_DSL.Material} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MaterialItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addQuantityPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Material_quantity_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Material_quantity_feature",
								"_UI_Material_type"),
						MHW_API_DSLPackage.Literals.MATERIAL__QUANTITY, true, false, false,
	...
	protected void addArmorPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Material_armor_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Material_armor_feature",
								"_UI_Material_type"),
						MHW_API_DSLPackage.Literals.MATERIAL__ARMOR, true, false, true, null, null, null));
	}
	...
	protected void addItemPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Material_item_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Material_item_feature",
								"_UI_Material_type"),
						MHW_API_DSLPackage.Literals.MATERIAL__ITEM, true, false, true, null, null, null));
	}
