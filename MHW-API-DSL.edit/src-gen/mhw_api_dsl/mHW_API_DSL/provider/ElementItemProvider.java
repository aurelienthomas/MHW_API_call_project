...
/**
 * This is the item provider adapter for a {@link mhw_api_dsl.mHW_API_DSL.Element} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ElementItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						MHW_API_DSLPackage.Literals.ELEMENT__NAME, true, false, false,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Element_value_feature",
								"_UI_Element_type"),
						MHW_API_DSLPackage.Literals.ELEMENT__VALUE, true, false, false,
	...
	protected void addWeaponPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Element_weapon_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Element_weapon_feature",
								"_UI_Element_type"),
						MHW_API_DSLPackage.Literals.ELEMENT__WEAPON, true, false, true, null, null, null));
	}
